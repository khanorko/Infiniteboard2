...
import { Cluster, CLUSTER_PRESETS, Point } from '../types';
...
const ClusterGroup: React.FC<ClusterGroupProps> = ({ cluster, offset, scale, onUpdate }) => {
  ...
  const screenX = (cluster.x + offset.x) * scale;
  const screenY = (cluster.y + offset.y) * scale;
  ...
  return (
    ...
    >
        ...
        <div 
            ...
            style={{ top: -16 * scale }} // Scale offset slightly
